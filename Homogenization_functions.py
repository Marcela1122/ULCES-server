...
# To adjust the range and nonlinear response of parameters:
def map_value(
        value,
        range_in=(0, 1),
        range_out=(0, 1),
...
# Exposure fusion: technique for blending multiple exposures of the same scene (bracketing) into a single image.
def get_membership_luts(
    ...
    '''
    ---------------------------------------------------------------------------
               Creates 3 parametric trapezoid membership functions
    ---------------------------------------------------------------------------
...
def get_sigmoid_lut(
    ...
    '''
    ---------------------------------------------------------------------------
           Creates a parametric sigmoid function and stores it in a LUT
    ---------------------------------------------------------------------------
...
def enhance_image(image, parameters, verbose=False):
    ...
    if 'local_contrast' in parameters:
        ...
        parameters['local_contrast'] = 1.2  # default: slight increase
    ...
    if 'mid_tones' in parameters:
        ...
        parameters['mid_tones'] = 0.5  # default: middle of the range
    ...
    if 'tonal_width' in parameters:
        ...
        parameters['tonal_width'] = 0.5  # default: middle of the range
    ...
    if 'areas_dark' in parameters:
        ...
        parameters['areas_dark'] = 0.2  # default: gentle increase
    ...
    if 'areas_bright' in parameters:
        ...
        parameters['areas_bright'] = 0.2  # default: gentle increase
    ...
    if 'saturation_degree' in parameters:
        ...
        parameters['saturation_degree'] = 1.2  # default: slight increase
